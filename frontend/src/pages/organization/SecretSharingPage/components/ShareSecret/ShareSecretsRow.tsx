...
import { ClockAlertIcon, ClockIcon, Ellipsis, History, Mail, MailOpen, Trash2 } from "lucide-react";
...
export const ShareSecretsRow = ({
  ...
  row: TSharedSecret;
  handlePopUpOpen: (
    popUpName: keyof UsePopUpState<["deleteSharedSecretConfirmation", "accessHistory"]>,
      ...
      <TableCell>
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem onClick={() => handlePopUpOpen("accessHistory", row)}>
              <History />
              Access history
            </DropdownMenuItem>
            <DropdownMenuItem
